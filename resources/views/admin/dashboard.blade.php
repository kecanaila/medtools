    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Welcome back, {{ auth()->user()->name }}! Manage the entire system.
            </p>
        </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $pendingVendors }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">Rp.{{ number_format($totalRevenue, 2) }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">
                                            {{ $order->user->name }} • {{ $order->created_at->format('M j, Y g:i A') }}
                                        </p>
            ...
            <div class="bg-white border border-gray-200 rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-medium text-gray-900">Pending Vendor Approvals</h2>
                ...
                <div class="divide-y divide-gray-200">
                    @if($pendingVendorsList->count() > 0)
                        @foreach($pendingVendorsList as $vendor)
                            <div class="px-6 py-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">
                                        ...
                                        <p class="text-xs text-gray-500">
                                            Applied {{ $vendor->created_at->diffForHumans() }}
                                        </p>
                                    </div>
                    ...
                    @else
                        <div class="px-6 py-8 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">All vendor applications have been processed.</p>
                        </div>
                    @endif
                </div>
            </div>
                   ...
                   class="bg-blue-600 text-white p-4 rounded-lg hover:bg-blue-700 transition-colors">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm opacity-90">View and manage all users</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.categories.index') }}" 
                   class="bg-yellow-600 text-white p-4 rounded-lg hover:bg-yellow-700 transition-colors">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-sm opacity-90">View and manage product categories</p>
                        </div>
                    </div>
                </a>
            </div>
