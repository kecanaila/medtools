        ...
        <div class="mb-8 flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update your product details below.</p>
                </div>
            </div>
                ...
                <form action="{{ route('vendor.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="linkImage" id="linkImage" value="{{ old('linkImage', $product->linkImage) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 transition placeholder-gray-400"
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-3">
                        <a href="{{ route('vendor.products.index') }}" 
                           class="inline-flex items-center bg- text-white px-4 py-2 rounded-md shadow transition hover:bg-gray-700">
                            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                            </svg>
                            Cancel
